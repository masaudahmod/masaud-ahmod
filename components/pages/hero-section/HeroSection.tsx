...
function HeroSection() {
  return (
    <section className="min-h-screen p-2 container mx-auto flex items-center justify-center py-4 lg:py-12 bg-masaud-dev-primary-black">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              >
                ...
                <RiContactsFill className="z-10" size={16} />
              </button>
            </Link>
            <Link
              data-cursor={true}
            ...
            >
              <button
                ...
                className="px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3"
              >
                <span className="z-10">Get Resume</span>
                <MdDownload className="z-10" size={16} />
              </button>
            </Link>
          </div>
        </div>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Masaud Ahmod</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
