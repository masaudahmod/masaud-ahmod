            ...
            <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
              <div className="font-Header text-justify">
                <span className="text-gray-400 ">
                  ...
                  <span data-cursor={true} className="p-1 text-AAsecondary">
              ...
              <div className="font-Header text-justify">
                <span className="text-gray-400 ">
                  ...
                  full-stack developer has been fueled by curiosity and a
                  passion for problem-solving. I thrive on building
                  high-performance web applications using technologies like
                  Next.js, Firebase, Redux Toolkit, and MongoDB. Whether
                  crafting sleek UI components, optimizing API performance, or
                  experimenting with AI-driven solutions, I love pushing the
              ...
              <div className="font-Header tracking-wide flex flex-row space-x-16  justify-start lg:justify-start">
