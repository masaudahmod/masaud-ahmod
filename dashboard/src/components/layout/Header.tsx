...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-(--border) bg-(--header-bg) backdrop-blur-md">
      <div className="flex flex-col gap-4 px-4 py-4 lg:px-6 lg:py-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="pl-12 lg:pl-0">
            <p className="font-label text-(--text-subtle)">
              Portfolio CMS Admin
            </p>
          ...
          <div className="flex flex-1 items-center justify-end gap-3 lg:max-w-xl lg:flex-none">
            ...
            <button
              ...
              className="flex h-9 items-center gap-2 cursor-pointer rounded-lg border border-(--border) px-2 text-sm text-(--text-muted) hover:text-(--text-primary)"
              aria-label="Sign out"
            >
              <LogOut className="h-4 w-4" />
            </button>
            {/* <div className="h-9 w-9 shrink-0 overflow-hidden rounded-full border border-(--border) bg-linear-to-br from-(--accent) to-blue-400" /> */}
          </div>
        </div>
